...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference("Garden.count") do
      post gardens_url, params: { garden: { description: @garden.description, name: @garden.name, user_id: @garden.user_id, zip: @garden.zip } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { description: @garden.description, name: @garden.name, user_id: @garden.user_id, zip: @garden.zip } }
